...
// We define the object that contains the overlays. This overlay will be visible all the time
let overlays ={
...
function styleInfo(feature) {
    ...
    // Earthquakes with a radius of 0 will be plotted with a radius of 1
...
d3.json(earthQuakes).then(function(data) {
    ...
    L.geoJSON(data, {
        ...
        style: styleInfo,
        // We create a popup for each circlemarker to display the magnitude & location of the earthquake after the marker has been created and styled
        onEachFeature: function(feature, layer) {
            layer.bindPopup("Magnitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place + "</br>");
        }
    }).addTo(earthquakes);
