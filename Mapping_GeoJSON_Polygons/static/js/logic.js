// 14.5.6 Skill Drill: Edit your logic.js file with the following changes:
...
let torontoHoods = "https://raw.githubusercontent.com/SNwokolo/Mapping_Earthquakes/main/torontoNeighborhoods.json";
...
d3.json(torontoHoods).then(function(data) {
    ...
    // Creating a GeoJSON layer with thee retrieved data
    L.geoJson(data, {
        style: myStyle,
